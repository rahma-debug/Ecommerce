...
if(isset($_POST['editer'])){
    $reponse = $bdd->prepare ('SELECT * FROM manufacturer WHERE id = ?');
...
if(isset($_POST['valider'])){
    ...
    $req = $bdd->prepare('UPDATE manufacturer SET label=:label,reference=:reference,
                                        email=:email,phone=:phone,
                                        country=:country,address1=:add1,address2=:add2,
                                        city=:city,zipcode=:zipcode WHERE id = :code');
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Editer Fournisseur</a>
                  </div>
              </div>
          </nav>
          <div class="content">
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-md-12">
                          <form id="TypeValidation" class="form-horizontal" action="EditerFournisseurs.php" method="post">
                              <div class="card ">
