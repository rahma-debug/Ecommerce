  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand tim-note" href="login.php">PAGE DE CONNEXION</a>
      </div>
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="material-icons">shopping_cart</i> SportingClub
            </a>
          </li>
          ...
          <li class="nav-item ">
            <a href="#" onclick="close_window();return false;" class="nav-link">
              <i class="material-icons">highlight_off</i> Sortie
            </a>
          </li>
        </ul>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  <p class="card-description text-center text-danger">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="username" required placeholder="Nom...">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control" name="useremail" required placeholder="Email...">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2019 12:40:22 GMT -->
</html>
