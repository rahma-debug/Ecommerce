...
if(isset($_POST['valider'])){
        $label = htmlspecialchars($_POST['nomCat']);
        $reference = htmlspecialchars($_POST['refCat']);
        $image = htmlspecialchars($_POST['imageCat']);
        $description = htmlspecialchars($_POST['descCat']);

        $req = $bdd->prepare('UPDATE category SET reference = :reference, label = :label,description = :description,photo = :image WHERE id = :code');
        $req->execute(array(
            'reference' => $reference,
            'label' => $label,
...
if(isset($_POST['validerSub'])){
        $label = htmlspecialchars($_POST['nomSubCat']);
        $reference = htmlspecialchars($_POST['refSubCat']);
        $description = htmlspecialchars($_POST['descSubCat']);

        $req = $bdd->prepare('UPDATE subcategory SET reference = :reference, label = :label,description = :description WHERE id = :id');
        $req->execute(array(
            'reference' => $reference,
            'label' => $label,
            'description' => $description,
          ...
          <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
              <div class="container-fluid">
                  <div class="navbar-wrapper">
                      ...
                      <a class="navbar-brand" href="#pablo">Editer Categories</a>
                  </div>
              </div>
          </nav>
          <div class="content">
                              ...
                              <div class="card-body">
                                  <ul class="nav nav-pills nav-pills-info" role="tablist">
                                      <li class="nav-item">
                                            ...
                                            <?php
                                                if($_SESSION['val']=="Cat"){
                                                    echo '<a class="nav-link active show" data-toggle="tab" href="#link1" role="tablist">Categories';
                                                }
                                            ?>
                                      ...
                                      <li class="nav-item">
                                              ...
                                              <?php
                                              if($_SESSION['val']=="SubCat"){
                                                  echo '<a class="nav-link active show" data-toggle="tab" href="#link2" role="tablist">Sous-catégories';
                                              }
                                              ?>
                                  ...
                                  <div class="tab-content tab-space">
                                      <div class="tab-pane <?php if($_SESSION['val']=="Cat"){echo ' active show';} ?>" id="link1">
                                          <form id="TypeValidation" class="form-horizontal" action="EditerCategorie.php" method="post">
                                              <div class="row">
                                      ...
                                      <div class="tab-pane <?php if($_SESSION['val']=="SubCat"){echo ' active show';} ?>" id="link2">
                                          <form id="TypeValidation" class="form-horizontal" action="EditerCategorie.php" method="post">
                                              <div class="row">
                                                  <div class="col-sm-1"></div>
                                                  <div class="col-sm-10">
                                              ...
                                              <div class=" row ml-auto mr-auto">
                                                  ...
                                                  <div class="col"></div>
                                                  <div class="col-sm-1">
                                                      <button type="submit" name="validerSub" class="btn btn-primary" ">Valider</button>
                                                  </div>
                                                  <div class="col-sm-1">
                                                      <button type="submit" name="annuler" class="btn btn-danger">Annuler</button>
                                                  </div>
